...
<body>
    ...
    <div class="container">
        <div class="row">
            ...
            // Consulta SQL para obtener los productos de limpieza
            $sql = "SELECT ProductoID, Nombre, Precio, RutaImagen FROM producto WHERE ProductoCategoriaID = 'Limpieza' AND Activo = 1";
            ...
            <?php
                ...
                echo "No se encontraron productos de limpieza.";
            }
