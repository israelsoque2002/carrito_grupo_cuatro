    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-8 mb-4">
                ...
                <form id="contact-form" method="post" action="procesar_contacto.php">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control" id="contact-email" name="email" placeholder="Tu correo electrónico" required>
                    </div>
                    <div class="form-group">
                        <label for="contact-phone">Teléfono</label>
                        <input type="tel" class="form-control" id="contact-phone" name="telefono" placeholder="Tu teléfono" required>
                    </div>
                    <div class="form-group">
                        <label for="contact-message">Mensaje</label>
                        <textarea class="form-control" id="contact-message" name="mensaje" rows="5" placeholder="Tu mensaje" required></textarea>
                    </div>
                ...
                <div class="modal-body">
                    <form id="login-form" method="post" action="procesar_login.php">
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" id="login-email" name="email" placeholder="Tu correo electrónico" required>
                        </div>
                        <div class="form-group">
                            <label for="login-password">Contraseña</label>
                            <input type="password" class="form-control" id="login-password" name="password" placeholder="Tu contraseña" required>
                        </div>
