...
<body>
    ...
    <div class="container">
        <div class="row">
            ...
            // SQL query to fetch products from 'aseo_personal' category
            $sql = "SELECT ProductoID, Nombre, Precio, RutaImagen FROM producto WHERE ProductoCategoriaID = 'Aseo Personal' AND Activo = 1";
            ...
            <?php
                ...
                echo "No se encontraron productos de aseo personal.";
            }
